...
class EnergyDataset(DGLDataset, Dataset):

    def __init__(self, test_size):
        self.test_size = test_size
        super(EnergyDataset, self).__init__(name='EnergyDataset')

    def process(self):
        self.data = np.load("../../energyDataset/energy.npy")
...
if __name__ == '__main__':
    dataset = EnergyDataset(test_size=0.1)
    print(dataset)
