...
class GolfDataset(DGLDataset, Dataset):

    def __init__(self, test_size):
        self.test_size = test_size
        super(GolfDataset, self).__init__(name='GolfDataset')

    def process(self):
        self.data = np.load("../../golf_dataset/olddata/old_data_preprocess_no_aug.npy")
        self.label = np.load("../../golf_dataset/olddata/labels.npy")
...
if __name__ == '__main__':
    dataset = GolfDataset(test_size=0.1)
    print(dataset)
